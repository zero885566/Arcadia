...
<div class="greybody" style="background-color: #EEEEEE;">  
    <div >
    <div class="acivity" style="background-color: #EEEEEE;">
    <!-- date picker  -->
    <!---------- BreadCrumbs ---------->
...
<button class="skpBtn rwdBtn" href="">跳過活動選擇</button> 
                    ...
                    <div class="accordion__content">
                        <div class="activityCard">
                            <div class="activity" data-id="ac1">
                                <div class="activityimg"><img class="coverfit" src="img/activity/1.jpg"
                                        alt="">
                            ...
                            <div class="activity" data-id="ac2">
                                <div class="activityimg"><img class="coverfit" src="img/activity/experience_28.jpg"
                                        alt="">
                                    <!-- Button trigger modal -->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="eventdetailone">
                                                    <div class="eventDetail">
                                                        <img class="eventimg coverfit"
                                                            src="img/activity/experience_28.jpg"></img>
                                                        <div class="eventText">
                    ...
                    <div class="accordion__content">
                        <div class="activityCard">
                            <div class="activity" data-id="ac3">
                                <div class="activityimg"><img class="coverfit" src="img/activity/2.jpg"
                                        alt="">
                                    <!-- Button trigger modal -->
                            ...
                            <div class="activity" data-id="ac4">
                                <div class="activityimg"><img class="coverfit"
                                        src="img/activity/experience_6.jpg" alt="">
                                    <!-- Button trigger modal -->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="eventdetailone">
                                                    <div class="eventDetail">
                                                        <img class="eventimg coverfit"
                                                            src="img/activity/experience_6.jpg"></img>
                                                        <div class="eventText">
                    ...
                    <div class="accordion__content">
                        <div class="activityCard">
                            ...
                            <div class="activity" data-id="ac6">
                                <div class="activityimg"><img class="coverfit" src="img/activity/experience_4yoga.jpg"
                                        alt="">
                                    <!-- Button trigger modal -->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="eventdetailone">
                                                    <div class="eventDetail">
                                                        <img class="eventimg coverfit"
                                                            src="img/activity/experience_4yoga.jpg"></img>
                                                        <div class="eventText">
                    ...
                    <div class="accordion__content">
                        <div class="activityCard">
                            <div class="activity" data-id="ac7">
                                <div class="activityimg"><img class="coverfit" src="img/activity/4.jpg" alt="">
                                    <!-- Button trigger modal -->
                            ...
                            <div class="activity" data-id="ac8">
                                <div class="activityimg"><img class="coverfit" src="img/activity/experience_5drink.jpg"
                                        alt="">
                                    <!-- Button trigger modal -->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="eventdetailtwo">
                                                    <div class="eventDetail">
                                                        <img class="eventimg coverfit"
                                                            src="img/activity/experience_5drink.jpg"></img>
                                                        <div class="eventText2">
                    ...
                    <div class="accordion__content">
                        <div class="activityCard">
                            <div class="activity" data-id="ac9">
                                <div class="activityimg"><img class="coverfit"
                                        src="img/activity/images.jpg" alt="">
                                    <!-- Button trigger modal -->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="eventdetailtwo">
                                                    <div class="eventDetail">
                                                        <img class="eventimg coverfit"
                                                            src="img/activity/images.jpg"></img>
                                                        <div class="eventText2">
                            ...
                            <div class="activity" data-id="ac10 ">
                                <div class="activityimg"><img class="coverfit" src="img/activity/michigan-beach-wedding.jpg"
                                        alt="">
                                    <!-- Button trigger modal -->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="eventdetailtwo">
                                                    <div class="eventDetail">
                                                        <img class="eventimg coverfit"
                                                            src="img/activity/michigan-beach-wedding.jpg"></img>
                                                        <div class="eventText2">
    ...
    <!-- <img src="/proj58/proj_arcadia/imgexperience_5drink.jpg" alt=""> -->
                                                        ...
                                                        <div class="orderList">
                                                            <div class="order">
                                                                ...
                                                                for ($i = 0; $i < $num; $i++) : ?>
                                                                    ...
                                                                    <div class="infoImg">
                                                                        <img class="coverfit" src="img/activity/roomOverview-room3.jpg" alt="">
                                                                    </div>
    ...
    <script>
        const allactive = {
            ac1: {
                acname: 'A.浮潛潛水',
                acprice: 3500,
                acimg: 'img/activity/1.jpg',
            },
            ac2: {
                acname: '衝浪體驗',
                acprice: 1800,
                acimg:'img/activity/experience_28.jpg'
            },
            ac3: {
                acname: '生態探訪',
                acprice: 800,
            ...
            ac4: {
                acname: '古蹟尋訪',
                acprice: 800,
                acimg:'img/activity/experience_6.jpg'
            },
            ac5: {
                acname: '薰香按摩',
                acprice: 2500,
            ...
            ac6: {
                acname: '紓壓瑜珈',
                acprice: 1800,
                acimg:'img/activity/experience_4yoga.jpg'
            },
            ac7: {
                acname: '派對規劃',
                acprice: 10000,
                acimg:'img/activity/4.jpg'

            },
            ac8: {
                acname: '尾牙春酒',
                acprice: 10000,
                acimg:'img/activity/experience_5drink.jpg'

            },
            ac9: {
                acname: '求婚服務',
                acprice: 0,
                acimg:'img/activity/images.jpg'

            },
            ac10: {
                acname: '婚宴服務',
                acprice: 0,
                acimg:'img/activity/michigan-beach-wedding.jpg'
            },
        }
